...
uint64_t
ft_strlen_stupid(const char *str) {
    const char *s;
...
main() {
    ...
    printf("ft_strlen_fast took %.2f ms\n", end - start);

    start = get_time_ms();
    ft_strlen_stupid(str);
    end = get_time_ms();
    printf("ft_strlen_stupid took %.2f ms\n", end - start);
